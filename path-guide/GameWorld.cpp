    ...
    if ( this->drawingPath ) {
        ...
        if ( IsMouseButtonDown( MOUSE_BUTTON_LEFT ) ) {
            ...
            if ( curves.empty() ) {
                ...
                this->tempCurve.setC1( xPress, yPress );
                this->tempCurve.setC2( x, y );
                this->tempCurve.setP2( x, y );
            } else {
                Curve curve = curves[curves.size()-1];
                this->tempCurve.setP1( curve.getP2().x, curve.getP2().y );
                this->tempCurve.setC1( curve.getP2().x, curve.getP2().y );
                this->tempCurve.setC2( x, y );
                this->tempCurve.setP2( x, y );
            }
        ...
        if ( IsMouseButtonDown( MOUSE_BUTTON_LEFT ) && 
            ...
            if ( this->selectedCurve->getCP1() == this->selectedControlPoint ) {
